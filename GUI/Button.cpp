...
void Button::updateTextPosition() {
    this->text.setPosition(this->shape.getPosition().x+(this->shape.getGlobalBounds().width-2*this->outlineThickness)/2.f-this->text.getGlobalBounds().width/2.f, this->shape.getPosition().y+(this->shape.getGlobalBounds().height-2*this->outlineThickness)/2.f-this->textSize*11/40-this->textSize*9/20);
}
